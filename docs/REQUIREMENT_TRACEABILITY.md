...
| UI-SIM-002 | **Implemented** | `frontend/src/App.test.tsx`; browser proof: `frontend/e2e/operator-critical-path.spec.ts` | `make test-unit`; browser proof: `make test-ui-features` |
| UI-SIM-005 | **Implemented** | `frontend/src/App.test.tsx`; browser proof: `frontend/e2e/operator-critical-path.spec.ts` | `make test-unit`; browser proof: `make test-ui-features` |
| UI-SETTLE-004 | **Implemented** | `frontend/src/SettlementWorkspace.test.tsx`; browser proof: `frontend/e2e/operator-critical-path.spec.ts` | `make test-unit`; browser proof: `make test-ui-features` |
| UI-LEDGER-006 | **Implemented** | `frontend/src/SettlementWorkspace.test.tsx`; browser proof: `frontend/e2e/operator-critical-path.spec.ts` | `make test-unit`; browser proof: `make test-ui-features` |
