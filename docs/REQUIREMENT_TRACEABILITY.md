...
| Remote collaboration, publication, tag, release | **Pending hosted evidence** | The public [Nexoflow repository](https://github.com/TakayukiKomatsu/nexoflow) exists. Assignment remediation was autosquashed and integrated before the initial direct push to `main` at [`3a01ab7`](https://github.com/TakayukiKomatsu/nexoflow/commit/3a01ab7c97aa9730fb29f4d58e3b84fb8a478cfe). Hosted CI [run `30502414061`](https://github.com/TakayukiKomatsu/nexoflow/actions/runs/30502414061) failed because the Ubuntu runner lacked the `zsh` required by the Java wrapper. This cleanup branch makes the wrapper portable, but no hosted green run has been observed. No hosted PR, reviewer approval, new release tag, or public release exists; `v1.0.0` at `af898ef` remains historical | Hosted links record publication and the failed run only; `make test-local-collaboration-evidence` remains local simulation |
...
| REL-004 | **Pending hosted evidence** | `docs/sdd/12_sdd_authorized-collaboration-crisis-publication-and-release-evidence.md`; publication exists at [`3a01ab7`](https://github.com/TakayukiKomatsu/nexoflow/commit/3a01ab7c97aa9730fb29f4d58e3b84fb8a478cfe), while hosted PR/reviewer approval/new release evidence remains absent | Hosted CI [run `30502414061`](https://github.com/TakayukiKomatsu/nexoflow/actions/runs/30502414061) failed on the non-portable Java wrapper; the cleanup branch fix has no hosted green evidence yet; `make test-crisis-evidence` is local evidence only |
