...
public interface ReferenceRateService {
    ...
    record BaseRate(String currency, BigDecimal monthlyRate, Instant effectiveAt) {}
    record ProductSpread(String productType, BigDecimal monthlySpread, Instant effectiveAt) {}
}
